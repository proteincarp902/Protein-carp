...
/* شاشة الشيفات: قسم مميز + شريط أقسام، بدل شبكة كروت متعبة */
function renderChefs(){
...
/* الإنتاج: الأصناف ظاهرة، وعند اختيار صنف تظهر خانة العدد والإضافة */
function renderProduction(){
  if(!currentChef) return renderChefs();
...
/* السلة: الأصناف ظاهرة، وعند اختيار الصنف تظهر الكمية والإضافة */
function renderWarehouseRequest(){
  if(!currentChef) return renderChefs();
  currentCart=currentCart||[];
